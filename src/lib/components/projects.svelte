  ...
  const projects = [
    {
      ...
      img_url: "/assets/projects/ratemyloo.png",
    ...
    },
    {
      ...
      img_url: "/assets/projects/discordbot.png",
      tags: ["python", "firebase", "discord.py"]
    },
    {
      name: "UniPals",
      url: "https://github.com/johncmanuel/UniPals",
      desc: "A website that allows users, specifically university students, to connect with others and socialize. LA Hacks 2021 Submission.",
      img_url: "/assets/projects/unipals.png",
    ...
    },
    {
      ...
      img_url: "/assets/projects/xplora.png",
    ...
    },
    {
      ...
      img_url: "/assets/projects/20yrs.png",
      tags: ["writing"]
    }
  ];
</script>
